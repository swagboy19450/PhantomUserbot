...
@borg.on(phantom_cmd(pattern="cpfp ?(.*)"))
async def autopic(event):

    await event.edit("Colour Profile Pic have been successfully enabled")
    ...
    while True:
        ...
        drawn_text.text((250, 250), f"{DEFAULTUSER}",
                        font=ofnt, fill=(FR, FG, FB))
        img.save(photo)
