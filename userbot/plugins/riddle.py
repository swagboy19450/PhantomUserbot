...
async def _(event):
    ...
    if x == 57:
        ...
        await event.edit('`"I am a seven letter word. I am very heavy. Take away two letters from me and you will get 8. Take away one letter from me and you will get 80. Who am I?"`')


    if x == 58:


        await event.edit('`"I am soft and transparent. I am so small that you can keep me on your fingers. I have no light but I help you to see the beautiful world. I improve your vision only when I come in contact with you. Who am I?"`')
